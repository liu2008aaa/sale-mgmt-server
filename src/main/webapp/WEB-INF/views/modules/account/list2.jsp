...
<script type="text/javascript">
	...
	function toPrint(act) {
		var url = '${ctx}/account/list?type=2&action=2&act=' + act;
	...
	function toExport(act) {
		var url = '${ctx}/account/list?type=2&act=' + act + "&export=1";
		$('#searchForm').attr("action", url);
		$('#searchForm').submit();
		resetFormAction();
	}
...
<body>
	<form:form id="searchForm" modelAttribute="tabAccounts"
		action="${ctx}/account/list?type=2" method="post"
		...
		<ul class="ul-form">
			...
			<li class="btns"><input id="btnSubmit" class="btn btn-primary"
				...
				<input id="btnSubmitDayin"
				class="btn btn-primary" type="button" value="打印本页" onclick="toPrint(1)" />
				<input id="btnSubmitDayin"
				class="btn btn-primary" type="button" value="打印全部" onclick="toPrint(2)" />
